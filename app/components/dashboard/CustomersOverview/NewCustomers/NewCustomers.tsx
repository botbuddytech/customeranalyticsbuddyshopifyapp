...
function getDescription(dateRange: string): string {
  switch (dateRange) {
    case "today":
      return "New customers today";
    case "yesterday":
      return "New customers yesterday";
    case "7days":
    case "last7Days":
      return "New customers in the last 7 days";
    case "30days":
    case "last30Days":
      return "New customers in the last 30 days";
    case "90days":
    case "last90Days":
      return "New customers in the last 90 days";
    case "thisMonth":
      return "New customers this month";
    case "lastMonth":
      return "New customers last month";
    default:
      return "New customers in the selected period";
  }
}
...
/**
 * New Customers Card Component
 *
 * Fetches and displays new customers count independently.
...
export function NewCustomers({
  ...
  const getExportFilename = () => {
    ...
    return `new-customers-${rangeLabel}-${dateStr}`;
  };
  ...
  return (
    <>
      ...
      <DashboardSegmentModal
        ...
        title={`New Customers${getDateRangeLabel(dateRange) ? ` - ${getDateRangeLabel(dateRange)}` : ""}`}
