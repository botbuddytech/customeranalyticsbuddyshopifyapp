/**
 * Automation Logic for Task 1: "Use AI to generate your first customer segment"
 * 
 * This file contains the logic to automatically mark this task as complete
 * when the criteria are met.
 * 
 * Task ID: 1
 * Task Name: "Use AI to generate your first customer segment"
 */
...
export async function checkTaskCompletion(context: AutomationContext): Promise<boolean> {
  ...
  // - Has the user generated at least one customer segment using AI?
  // - Check saved lists with source "ai-search"
  // - Check if there's at least one segment created via AI search
